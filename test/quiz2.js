...
function test() {
    ...
    var Oberösterreich = "Oberösterreich";
    var Linz = "Linz";
    
    var Niederösterreich = "Niederösterreich";
    var StPölten = "St.Pölten";
    ...
    switch(numBundes1){
        case (numBundes1 == 1):
            var txtBundes1 = Burgenland;
            var txtHaupt1 = Eisenstadt;   
            break;
        case (numBundes1 == 2):
            var txtBundes1 = Kärnten;
            var txtHaupt1 = Klagenfurt;
            break;
        case (numBundes1 == 3):
            var txtBundes1 = Niederösterreich;
            var txtHaupt1 = StPölten;
            break;
        case (numBundes1 == 4):
            var txtBundes1 = Oberösterreich;
            var txtHaupt1 = Linz;   
            break;
        case (numBundes1 == 5):
            var txtBundes1 = Salzburg;
            var txtHaupt1 = Salzburg;
            break;
        case (numBundes1 == 6):
            var txtBundes1 = Steiermark;
            var txtHaupt1 = Graz;
            break;
        case (numBundes1 == 7):
            var txtBundes1 = Tirol;
            var txtHaupt1 = Innsbruck;   
            break;
        case (numBundes1 == 8):
            var txtBundes1 = Voralberg;
            var txtHaupt1 = Bregenz;
            break;
        case (numBundes1 == 9):
            var txtBundes1 = Wien;
            var txtHaupt1 = Wien;
